...
function addListners(camera, renderer, composer) {
	...
	floatText.innerHTML = 'Merry Christmas to siyi !';
	...
	floatImg.classList.add('floatImg');
	floatImg.classList.add('animate__animated'); //动画默认加
	floatImg.classList.add('animate__fadeInUp'); //动画效果
	floatImg.classList.add('animate__delay-2s'); //动画延迟时间
